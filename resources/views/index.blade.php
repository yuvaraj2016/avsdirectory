...
<div class="site-blocks-cover overlay" style="background-image: url(frontend/images/natrajar.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        ...
        <div class="row col-md-12 align-items-center justify-content-center text-center" >
          ...
          <div class="col-md-6 ss" >
                <form action="">
                    ...
                    <div class="form-group form-check pl-0" style="padding-left: none !important;" >
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <h2 class="h5 mb-4 text-black">Recent Business Listing</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-12  block-13">
            <div class="owl-carousel nonloop-block-13">
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="{{('listings-single')}}" class="img d-block" style="background-image: url('frontend/images/img_1.jpg')"></a>
                <div class="lh-content">
                  <span class="category">Cars &amp; Vehicles</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="{{('listings-single')}}">Red Luxury Car</a></h3>
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="listings-single.html" class="img d-block" style="background-image: url('frontend/images/img_2.jpg')"></a>
                <div class="lh-content">
                  <span class="category">Real Estate</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="{{('listings-single')}}">House with Swimming Pool</a></h3>
                  <address>Don St, Brooklyn, New York</address>
                  <p class="mb-0">
                    <span class="icon-star text-warning"></span>
                    <span class="icon-star text-warning"></span>
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="{{('listings-single')}}" class="img d-block" style="background-image: url('frontend/images/img_3.jpg')"></a>
                <div class="lh-content">
                  <span class="category">Furniture</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="{{('listings-single')}}">Wooden Chair &amp; Table</a></h3>
                  <address>Don St, Brooklyn, New York</address>
                  <p class="mb-0">
                    <span class="icon-star text-warning"></span>
                    <span class="icon-star text-warning"></span>
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="{{('listings-single')}}" class="img d-block" style="background-image: url('frontend/images/img_4.jpg')"></a>
                <div class="lh-content">
                  <span class="category">Electronics</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="{{('listings-single')}}">iPhone X gray</a></h3>
                  <address>Don St, Brooklyn, New York</address>
                  <p class="mb-0">
                    <span class="icon-star text-warning"></span>
                    <span class="icon-star text-warning"></span>
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="{{('listings-single')}}" class="img d-block" style="background-image: url('frontend/images/img_2.jpg')"></a>
                <div class="lh-content">
                  <span class="category">Real Estate</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="{{('listings-single')}}">House with Swimming Pool</a></h3>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            <h2 class="font-weight-light text-primary">Gallery</h2>
          ...
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              <div class="listing-image">
                ...
                <img src="frontend/images/img_1.jpg" alt="Image" class="img-fluid mb-3" style="height:none">
              </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Recent Events</h2>
          </div>
        </div>
        <div class="row mt-5">
          <div class="col-lg-6">
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="frontend/images/person_3.jpg" alt="Image" class="img-fluid mb-3">
                <p>John Smith</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="frontend/images/person_2.jpg" alt="Image" class="img-fluid mb-3">
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="frontend/images/person_4.jpg" alt="Image" class="img-fluid mb-3">
                <p>Robert Spears</p>
              </figure>
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="frontend/images/person_5.jpg" alt="Image" class="img-fluid mb-3">
                <p>Bruce Rogers</p>
              </figure>
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
