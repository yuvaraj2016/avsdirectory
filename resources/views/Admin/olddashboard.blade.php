    ...
    <ul id="sidebarCookie">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="navDashboard">
                <ul class="flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadmin">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="navPageLayouts">
                <ul class="flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminboxed">
                            <i class="feather icon-bold"></i>
                            <span class="menu-title">Boxed</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminhorizontal">
                            <i class="feather icon-pause"></i>
                            <span class="menu-title">Horizontal Menu</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminboxedhorizontal">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="navElements">
                <ul class="flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminelements/bootstrap">
                            <i class="feather icon-bold"></i>
                            <span class="menu-title">Bootstrap</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminelements/gallery">
                            <i class="feather icon-image"></i>
                            <span class="menu-title">Gallery</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminelements/cards">
                            <i class="feather icon-credit-card"></i>
                            <span class="menu-title">Cards</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminelements/grid">
                            <i class="feather icon-grid"></i>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="navMailbox">
                <ul class="flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminapp/inbox">
                            <i class="feather icon-inbox"></i>
                            <span class="menu-title">Inbox</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminapp/inbox/email">
                            <i class="feather icon-mail"></i>
                            <span class="menu-title">Email</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminapp/inbox/compose">
        ...
        <li class="nav-item">
            <a href="http://localhost/bootadminapp/calendar" class="nav-link wave-effect nav-single">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="navProfilebox">
                <ul class="flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminaccount/profile">
                            <i class="feather icon-user"></i>
                            <span class="menu-title">Profile</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminaccount/billing">
                            <i class="feather icon-dollar-sign"></i>
                            <span class="menu-title">Billing</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link wave-effect" href="http://localhost/bootadminaccount/settings">
        ...
        <li class="nav-item">
            <a href="http://localhost/bootadmincredits" class="nav-link wave-effect nav-single">
